...
def get_file_single_lvl_var_running_hmean(ds='CP4A', res=4, var='q2', year=2000, window=6, months=[3, 4, 5], lat_range=(-6., 6.), lon_range=(37., 50.)):
...
def load_single_lvl_var_running_hmean(ds='CP4A', res=4, var='q2', year=2000, window=6, months=[3, 4, 5], lat_range=(-6., 6.), lon_range=(37., 50.)):
    """Load single level variable hourly mean values"""
    outfile = get_file_single_lvl_var_running_hmean(ds, res, var, year, window, months, lat_range, lon_range)
