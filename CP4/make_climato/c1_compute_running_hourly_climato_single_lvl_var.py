...
def get_path_single_lvl_var_running_hclimato(ds='CP4A', res=4, var='q2', year0=1997, year1=2006, lat_range=(-6., 6.), lon_range=(37., 50.)):
...
def load_single_lvl_var_running_hclimato(ds='CP4A', res=4, var='q2', year0=1997, year1=2006, window=6, months=[3, 4, 5], lat_range=(-6., 6.), lon_range=(37., 50.)):
    """Load single level variable climato"""
    m_ = "-".join([str(m) for m in months])

    outpath = get_path_single_lvl_var_running_hclimato(ds, res, var, year0, year1, lat_range, lon_range)
...
def load_single_lvl_var_hclimato(ds='CP4A', res=4, var='q2', year0=1997, year1=2006, window=6, months=[3, 4, 5], lat_range=(-6., 6.), lon_range=(37., 50.)):
    """Load single level variable climato"""
    m_ = "-".join([str(m) for m in months])
...
if __name__ == '__main__':
    ...
    for y in years:
        ...
        data_rm = load_single_lvl_var_running_hmean(ds, res, var, y, window, months, lat_range, lon_range)
