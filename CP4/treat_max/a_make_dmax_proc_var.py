...
def get_file_proc_var_dmax(ds='CP4A', res=4, var='twb', window=6, year0=1997, year1=2006, months=[3, 4, 5], lat_range=(-6., 6.), lon_range=(37., 50.)):
...
def load_proc_var_dmax(ds='CP4A', res=4, var='twb', window=6, year0=1997, year1=2006, months=[3, 4, 5], lat_range=(-6., 6.), lon_range=(37., 50.)):
    """Load processed variable daily max time series"""
    outfile = get_file_proc_var_dmax(ds, res, var, window, year0, year1, months, lat_range, lon_range)
