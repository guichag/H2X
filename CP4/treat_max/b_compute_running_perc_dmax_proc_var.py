...
def get_file_proc_var_dmax_running_quantile(ds='CP4A', var='twb', quantile=0.95, window_quantile=11, window=6, year0=1997, year1=2006, months=[3, 4, 5], lat_range=(-6., 6.), lon_range=(37., 50.)):
...
def load_proc_var_dmax_roll_quantile(ds='CP4A', var='twb', quantile=0.9, window_quantile=11, window=6, year0=1997, year1=2006, months=[3, 4, 5], lat_range=(-6., 6.), lon_range=(37., 50.)):
    """Load processed variable rolling quantile"""
    outfile = get_file_proc_var_dmax_running_quantile(ds, var, quantile, window_quantile, window, year0, year1, months, lat_range, lon_range)
...
if __name__ == '__main__':
    ...
    dmax = load_proc_var_dmax(ds, var, window, y0, y1, months, lat_range, lon_range)
